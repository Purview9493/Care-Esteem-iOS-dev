...
//        Params: \(paramsString)
//        """
//        if checkinAPITagg == "checkin" {
//            let alert = UIAlertController(title: "Parameters", message:message , preferredStyle: .alert)
//            // Copy action
//            let copyAction = UIAlertAction(title: "Copy", style: .default) { _ in
//                UIPasteboard.general.string = message
//                print("✅ Text copied to clipboard" ,message)
//            }
//            // Cancel action
//            let cancelAction = UIAlertAction(title: "Cancel", style: .cancel)
//            alert.addAction(copyAction)
//            alert.addAction(cancelAction)
//            // Present alert on main thread, from top VC
