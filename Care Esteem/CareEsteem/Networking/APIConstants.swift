...
enum APIType {
    ...
    case checkinValidation(userId: String)
    ...
    case addAlert
    case clearNotification(hash_token: String)
    ...
    var path: String {
        switch self {
        case .checkinValidation (let userId): return "checkin-validation/\(userId)"
        ...
        case .getClientCarePlanAss(let clientId): return  "get-client-careplan-ass-ios/\(clientId)"
            //"get-client-careplan-ass/\(clientId)"
        ...
        case .clearNotification: return "clear-notification"
